    ...
    <ScrollView>
      <View style={styles.headContainer}>
        <View style={styles.helloContainer}>
          ...
          <Text>{t("hopi.hello")}</Text>
          <Text>Keksk</Text>
        </View>
        <View style={styles.moneyContainer}>
          <Text style={styles.paracikText}>
            201.50 {t("hopi.paracikAmount")}
          </Text>
          <Text>
            1 {t("hopi.paracik")} = 1 {t("hopi.paracikDescription")}
          </Text>
          <TouchableOpacity>
            <Text style={{ textDecorationLine: "underline" }}>
              {t("hopi.paracikNavigationButtonTitle")}
            </Text>
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.carouselHead}>
        <Text style={styles.carouselHeadText}>{t("hopi.carouselTitle")}</Text>
      ...
      <View style={styles.suggestionsContainer}>
        <View>
          <Text style={styles.suggestionContainerTitle}>
            {t("hopi.suggestionContainerTitle")}
          </Text>
